...
public class Client {
    ...
    public void translateAddressToLocation() throws Exception{
        List<Map<String, String>> mapList = ReadExcelUtil.readExcel("d:\\Users\\shenmingli\\Desktop\\地址.xlsx");
        ...
        WriteExcelUtils.writeExcel(locationMap, "d:\\Users\\shenmingli\\Desktop\\经纬度.xlsx", "经纬度");
    }
}
