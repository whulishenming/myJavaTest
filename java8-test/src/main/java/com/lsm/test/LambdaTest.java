...
public class LambdaTest {
    ...
    public void testFunction() {
        ...
        Function<Integer, Integer> times22 = (i -> {
            return i * 2;
        });
        ...
        // 8
        System.out.println(Function.identity().compose(times2).apply(4));

    }

    @Test
    public void testBiFunction() {
        BiFunction<Integer, Integer, Integer> fun = (a, b) -> a * a + b * b;

        System.out.println(fun.apply(3, 4));
    }
    ...
    public void testComparator() {
        ...
        list.sort(Comparator.comparing(String::length).reversed() // 逆序
